...
> **Status:** 67 modules · **0 `sorry`** · axioms limited to `propext`, `Classical.choice`, `Quot.sound` (the mathlib standard three) · Lean `v4.32.0-rc1` + pinned mathlib.
>
...
lake build             # builds all 67 modules; success ⇒ every theorem holds
```
